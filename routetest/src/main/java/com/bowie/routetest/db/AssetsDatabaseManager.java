package com.bowie.routetest.db;
...
public class AssetsDatabaseManager {
    ...
    private static String databasepath = "/data/data/com.bowie.routetest/database"; // %s is packageName
    ...
    static public List<StationBean> selectByCode(int type, String lac, String ci){
